...
- in wind tunels small air crafrt are kept and wind in blown in them 
## methamatical model
-  it uses symbolic notation and mathamatical eqn 
## Static model
## Dynamic model : with respect to time change huni
## Determenistic model
- it contain no random variable but have a known set of inputs which will result in unique set of outputs 

- random input leads to random output 
